...
if __name__ == '__main__':
    ...
    test_a_path = os.path.join(args.dataset_path, 'testA')
    test_b_path = os.path.join(args.dataset_path, 'testB')
    ...
    train_a_path = os.path.join(args.dataset_path, 'trainA')
    train_b_path = os.path.join(args.dataset_path, 'trainB')
