...
path = root_folder + '/Mouse_actin/'
zip_file = 'Mouse_actin.zip'
url_download_from = 'https://owncloud.mpi-cbg.de/index.php/s/lt3yecHQMKJnJlB/download'
...
image_stack_images_train = image_stack_images[:, :, 512:]
image_stack_annotation_train = image_stack_annotation[:, :, 512:]

image_stack_images_test = image_stack_images[:, :, :512]
image_stack_annotation_test = image_stack_annotation[:, :, :512]
